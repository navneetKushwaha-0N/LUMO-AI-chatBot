      ...
      <main className="main-container">
        ...
        {currentConversation.messages.length === 0 ? (
          ...
          <div className="welcome-container">
            ...
            <h1 className="welcome-heading">Introducing Lumo AI </h1>
            <p className="welcome-text"> Lumo now has our smartest, fastest, most useful model yet.</p>
          </div>
        ) : (
          // Messages container
        ...
        <div className="prompt-container">
          ...
          <p className="disclaimer-text">Helpful, but not flawless — confirm if it matters.</p>
        </div>
      </main>
    </div>
  );
